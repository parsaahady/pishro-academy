(() => {
  ...
  const api = {
    ...
    getAdminTeamGallery: (team) => request(`admin/team-gallery.php${query({ team })}`),
    saveTeamGalleryImage: (team, formData) => request(`admin/team-gallery.php${query({ team })}`, { method: 'POST', body: formData }),
    deleteTeamGalleryImage: (team, id) => request(`admin/team-gallery.php${query({ team, id })}`, { method: 'DELETE' }),
